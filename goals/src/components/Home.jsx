    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-center from-black to-gray-800 text-white">
      ...
      <div className="max-w-2xl w-full p-4 flex flex-col items-center justify-center">
        ...
        <div className="mb-4">
          <Link
            to="/create"
            className="bg-primary-blue text-white py-1 px-2 rounded-md"
          >
            Add Goal
          </Link>
        </div>
              ...
              >
                ...
                <td className="px-3 md:px-6 py-2 md:py-4 flex flex-col">
                  <div className="flex flex-col items-center justify-center">
                    <Link
                      to={`/read/${goal.id}`}
                      className="text-primary-blue hover:underline mb-2 md:mb-0"
                    >
                      Read
                    </Link>
                    <Link
                      to={`/edit/${goal.id}`}
                      className="text-primary-pink hover:underline mb-2 md:mb-0"
                    >
                      Edit
                    </Link>
                    <button
